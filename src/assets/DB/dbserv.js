...
export const serviciosPrin=[
  ...
  details: "Construimos viviendas ecológicas modernas utilizando el sistema SIP LavaRock (paneles estructurales sándwich con placas de óxido de magnesio - MgO, volcanita y sílice de origen volcánico, y núcleo de poliestireno expandido de alta densidad). Este material avanzado ofrece una solución integral, rápida y sostenible para tu hogar. Desarrollamos planos completos en 2D (AutoCAD) y modelos 3D (Revit), adaptados específicamente al sistema de paneles LavaRock, incluyendo estructura, instalaciones eléctricas, sanitarias, gas y acabados. Cumplimos con las normas sismorresistentes y municipales de Apurímac, entregamos expedientes técnicos listos para aprobación y acompañamos todo el proceso de licencia de construcción.",
  caracteristicas: [
    "Construcción con paneles SIP LavaRock: estructura, aislamiento térmico y acústico en un solo panel",
    "Hasta 70% más rápida que la construcción tradicional (sin tiempos de secado)",
    "Alta resistencia sísmica: sistema monolítico flexible que absorbe energía en movimientos telúricos",
    "Resistente al fuego (material incombustible y refractario), humedad, salitre y condiciones climáticas extremas",
    "Excelente aislamiento térmico y acústico que reduce el consumo energético y mejora el confort",
    "Ecológico y sostenible: bajo peso, mínimo desperdicio de material y menor huella de carbono",
    "Menos mantenimiento a largo plazo: no se fisura fácilmente, resiste moho y salitre",
    "Modelado BIM en Revit con renders 3D fotorrealistas adaptados al sistema LavaRock",
    "Expediente técnico completo para licencia municipal, compatible con paneles SIP",
    "Entrega en formatos PDF, DWG y modelos 3D, con asesoría personalizada y modificaciones ilimitadas"
